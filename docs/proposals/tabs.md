...
It's not currently possible to set a hachure as the tab background or highlighted tab backgroup.
Wired.js's tabs are more customizable so we use the wired.js tab anchors to control the show/hide of Roughness's tab content.
We hide wired.js's content and Roughness's anchors to provide a unified look and feel.

It would be nice if Roughness's tabs had wired's customzability, so that this Frankenstein wasn't needed.
